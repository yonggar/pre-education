...
#### pull request는 브랜치를 기준으로 합니다. 따라서 Pull Request는 브랜치머더 한 번만 할 수 있습니다. 
#### merge되거나 close를 하면 다시 pull request를 할 수 있습니다. 
#### pull request 이후 브랜치 내용을 변경하면 자동으로 pull request에 변경내용에 반영됩니다. 
<br/> 
...
## Pull Request는 퀴즈를 다 풀고 진행하셔도 되고, 먼저 요청한 후 나머지 문제를 풀어도 됩니다.
## Pull Request는 브랜치 당 한번만 가능하다는 것을 기억해주세요! 
